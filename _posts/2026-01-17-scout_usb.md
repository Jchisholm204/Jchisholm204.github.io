---
title: Scout USB Driver Documentation
date: 2026-01-17
...
**USB Interface:** Documentation for the "Scout" USB CDC-ACM (Common Device Class - Abstract Control Model) interface built using FreeRTOS and [Dmitry Filimonchuk's `libusb_stm32`](https://github.com/dmitrystu/libusb_stm32) Hardware Abstraction Layer (HAL).
...
For more information, consult the [Simulation LiDAR Processing documentation](https://jchisholm204.github.io/posts/scout_sim_lidar/).
